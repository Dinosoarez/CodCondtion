...
#                                       fixed eff       
#M1 <- glmmTMB(log(gutwt) ~ log(length) + NAFOdiv,
#               dispformula =~ poly (log(length),2), data=gutcod_clean)
#AIC        BIC
#-202212.5 -202116.4
#nodisp
#AIC        BIC
...
#M2 <- glmmTMB(log(gutwt) ~ log(length) + NAFOdiv + ar1(month|dum),
#                dispformula =~ poly (log(length),2), data=gutcod_clean)
#AIC        BIC
#-212998.9 -212883.5
#nodisp
...
#                ar1(month-1|lenbin) + ar1(month-1|year),
#                dispformula =~ poly (log(length),2), data=gutcod_clean)
#AIC        BIC
#-221781.4 -221627.5
#nodisp
...
#                ar1(month-1|lenbin) + ar1(month-1|year) + ar1(year-1|dum),
#                dispformula =~ poly (log(length),2), data=gutcod_clean)
#AIC        BIC
#na          na
#nodisp
...
#                ar1(month-1|lenbin) + ar1(year-1|dum),
#                dispformula =~ poly (log(length),2), data=gutcod_clean)
#AIC        BIC
#na          na
#nodisp
...
#                ar1(month-1|lenbin) + ar1(year-1|dum) + ar1(year-1|month),
#                dispformula =~ poly (log(length),2), data=gutcod_clean)
#AIC        BIC
#-221792.4 -221619.3
#nodisp
...
#                ar1(month-1|lenbin) + ar1(year-1|month),
#                dispformula =~ poly (log(length),2), data=gutcod_clean)
#AIC        BIC
#-221780.0 -221626.2 
#nodisp
...
#                ar1(month-1|lenbin) + ar1(year-1|month) + ar1(month-1|year),
#                dispformula =~ poly (log(length),2), data=gutcod_clean)
#AIC        BIC
#na          na
#nodisp
...
#                ar1(month-1|lenbin) + ar1(year-1|month) + sex,
#                dispformula =~ poly (log(length),2), data=gutcod_clean)
#AIC        BIC
#-221778.2 -221614.7
#nodisp
...
#                ar1(month-1|lenbin) + ar1(year-1|month) + sex + ar1(year-1|NAFOdiv),
#                dispformula =~ poly (log(length),2), data=gutcod_clean)
#AIC        BIC
#-223228.6 -223045.8
#nodisp
...
#                ar1(month-1|lenbin) + ar1(year-1|month) + ar1(year-1|NAFOdiv),
#                dispformula =~ poly (log(length),2), data=gutcod_clean)
#AIC        BIC
#-223230.2 -223057.1
...
#save(M14, file = 'M14.RData')
load('M14.RData')


#TM14 <- glmmTMB(log(weight) ~ log(length) + NAFOdiv + ar1(month-1|dum) + 
#                ar1(month-1|lenbin) + ar1(year-1|month) + ar1(year-1|NAFOdiv),
#                dispformula =~ poly (log(length),2), data=gutcod_clean)

#only works with this disp formula
#AIC        BIC
#-194417.83 -194244.73 

#save(TM14, file = 'TM14.RData')
load('TM14.RData')
...
#nafo_2j_year_may <- predict_response(M14, c('year','length[40]','NAFOdiv[2J]','month[5]'), margin='empirical') 
#nafo_3k_year_may <- predict_response(M14, c('year','length[40]','NAFOdiv[3K]','month[5]'), margin='empirical') 
#nafo_3l_year_may <- predict_response(M14, c('year','length[40]','NAFOdiv[3L]','month[5]'), margin='empirical') 
#nafo_3n_year_may <- predict_response(M14, c('year','length[40]','NAFOdiv[3N]','month[5]'), margin='empirical') 
#nafo_3o_year_may <- predict_response(M14, c('year','length[40]','NAFOdiv[3O]','month[5]'), margin='empirical') 
#nafo_3p_year_may <- predict_response(M14, c('year','length[40]','NAFOdiv[3P]','month[5]'), margin='empirical') 
...
#save(nafo_pred_may, file= 'nafo_pred_may.RData')
...
#june
#nafo_2j_year_june <- predict_response(M14, c('year','length[40]','NAFOdiv[2J]','month[6]'), margin='empirical') 
#nafo_3k_year_june <- predict_response(M14, c('year','length[40]','NAFOdiv[3K]','month[6]'), margin='empirical') 
#nafo_3l_year_june <- predict_response(M14, c('year','length[40]','NAFOdiv[3L]','month[6]'), margin='empirical') 
#nafo_3n_year_june <- predict_response(M14, c('year','length[40]','NAFOdiv[3N]','month[6]'), margin='empirical') 
#nafo_3o_year_june <- predict_response(M14, c('year','length[40]','NAFOdiv[3O]','month[6]'), margin='empirical') 
#nafo_3p_year_june <- predict_response(M14, c('year','length[40]','NAFOdiv[3P]','month[6]'), margin='empirical') 
...
#save(nafo_pred_june, file= 'nafo_pred_june.RData')
...
year_month_effect(M14)

year_month_effect(M14, gutcod_clean, TRUE)
...
totalgut_nafo_year_effect <- function(totalmodel,totaldf,gutmodel){
  ...
  p
  #name <- "TM14vsM14_nafo_year_effect.jpeg"
  #ggsave(filename = name, device = "jpeg", plot = p, dpi=400, units="in", width=8, height=5)
}

totalgut_nafo_year_effect(TM14,gutcod_clean,M14)
...
totalgut_year_month_effect <- function(totalmodel,totaldf,gutmodel, subset=FALSE){
  ...
  p <- ggplot(data=gut_ef_year_final, aes(x=year, y=effect, group= month)) + 
    ...
    theme(axis.text.x = element_text(angle = 45, vjust = .6
          ...
          legend.position="none")
  p
  #name <- paste("TM14vsM14_",sub,"_year_month_effect.jpeg")
  #name <- str_replace_all(string=name, pattern=" ", repl="")
  #ggsave(filename = name, device = "jpeg", plot = p, dpi=400, units="in", width=8, height=5)
}

totalgut_year_month_effect(TM14,gutcod_clean,M14)

totalgut_year_month_effect(TM14,gutcod_clean,M14, TRUE)
```
...
totalgut_month_bin_effect <- function(totalmodel,totaldf,gutmodel){  
  ...
  p
  #name <- "TM14vsM14_month_bin_effect.jpeg"
  #ggsave(filename = name, device = "jpeg", plot = p, dpi=400, units="in", width=8, height=5)
}

totalgut_month_bin_effect(TM14,gutcod_clean,M14)
```
...
predicted_actual(M14)
#predicted_actual(TM14)
```
...
predicted_actual_histogram(M14)
#predicted_actual_histogram(TM14)
```

## Correlation Plots
Next we show the correlation matrix between the different NAFO divisions over time
```{r Correlation Matrix 1, echo=TRUE}
NAFO_year_corr_plot <- function(model=M14,df=gutcod_clean){  #function pulls a model, using mod11 and cod df
...
#jpeg(file="M14_NAFO_corr.jpeg", res=400, units="in", width=8, height=5)
...
month_year_corr_plot <- function(model=M14,df=gutcod_clean, subset=FALSE){  #function pulls a model, using mod11 and cod df
  ...
  #jpeg(file="M14_month_corr.jpeg", res=400, units="in", width=8, height=5)
  corrplot(cor_matrix, method = 'number')
  #dev.off()
...
This correlation matrix shows the similarity between NAFO Division for 
...
pred_wt_corr_plot <- function(df,month){
  ...
  name <- paste("M14_pred_weight_",month,"_corr.jpeg")
  name <- str_replace_all(string=name, pattern=" ", repl="")
...
Lastly, we plot the predicted total and gutted weight for a 40cm atlantic cod
across years.
```{r Predicted Total and Gutted Weight, echo=TRUE}

#pred by year total vs gut

#pred_total <- predict_response(TM14, c('year','length[40]'), margin='empirical')
#save(pred_total, file='pred_total.RData')
load('pred_total.RData')

#pred_gut <- predict_response(M14, c('year','length[40]'), margin='empirical')
#save(pred_gut, file='pred_gut.RData')
load('pred_gut.RData')


total_gut_pred_weight <- function(total,gut){
  #combine dfs
  total$group <- 'Total Weight Model'
  gut$group <- 'Gutted Weight Model'
  pred_df <- bind_rows(total,gut)
  
  #plot ontop of one another
  p <- ggplot(pred_df, aes(x=x, y=predicted, group=group))  +
    ...
    theme(legend.title = element_blank(),
          ...
          axis.title.x = element_text(size=15, face="bold", colour = "black"),    
          axis.title.y = element_text(size=15, face="bold", colour = "black"),
          strip.text = element_text(size =15),panel.grid.major = element_blank(), panel.grid.minor = 
          element_blank(),
          panel.background = element_blank(), axis.line = element_line(colour = "black"),
          text=element_text(family="Times New Roman"),
          strip.text.x = element_text(margin = margin(0.0,0,0.0,0, "cm")))
...
#jpeg(file="total_gut_pred_weight.jpeg", res=400, units="in", width=8, height=5)
total_gut_pred_weight(pred_total,pred_gut)
#dev.off()
